...
from localargo.providers.registry import get_provider, list_available_providers
...
class TestProviderRegistry:
    ...
    def test_get_provider_unknown_raises_error(self):
        ...
        with pytest.raises(ValueError, match="Unknown provider: unknown. Available providers: kind, k3s"):
    ...
    def test_registry_imports(self):
        ...
        from localargo.providers.registry import PROVIDERS
